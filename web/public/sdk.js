"use strict";var BCHPay=(()=>{var y=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var h=Object.getOwnPropertyNames;var g=Object.prototype.hasOwnProperty;var x=(e,r)=>{for(var o in r)y(e,o,{get:r[o],enumerable:!0})},b=(e,r,o,a)=>{if(r&&typeof r=="object"||typeof r=="function")for(let t of h(r))!g.call(e,t)&&t!==o&&y(e,t,{get:()=>r[t],enumerable:!(a=f(r,t))||a.enumerable});return e};var w=e=>b(y({},"__esModule",{value:!0}),e);var k={};x(k,{button:()=>u,closeModal:()=>c,createCheckout:()=>d,default:()=>S,openModal:()=>l});var C="https://bchpay.app/api/v1";async function d(e,r,o){let a=o.apiUrl||C,t=await fetch(`${a}/checkout/sessions`,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":e},body:JSON.stringify({amount:r,currency:"USD",memo:o.memo,success_url:o.successUrl,cancel_url:o.cancelUrl})});if(!t.ok){let n=await t.json().catch(()=>({error:"Request failed"}));throw new Error(n.error||`HTTP ${t.status}`)}return t.json()}var m=null;function l(e,r){c();let o=document.createElement("div");o.id="bchpay-overlay",o.style.cssText=`
  ...
  `,a.appendChild(t),a.appendChild(n),o.appendChild(a),o.addEventListener("click",s=>{s.target===o&&(c(),r.onCancel?.())});let p=s=>{!s.data||typeof s.data!="object"||(s.data.type==="bchpay:success"?(c(),r.onSuccess?.(s.data.payload)):s.data.type==="bchpay:cancel"?(c(),r.onCancel?.()):s.data.type==="bchpay:error"&&(c(),r.onError?.(new Error(s.data.message||"Payment failed"))))};if(window.addEventListener("message",p),o.dataset.messageHandler="true",o._messageHandler=p,!document.getElementById("bchpay-styles")){let s=document.createElement("style");s.id="bchpay-styles",s.textContent=`
